  ...
  return (
    ...
    <div className="px-6 flex items-center justify-between space-x-4">
      ...
      <div className="flex space-x-2">
        ...
        <Link href={'/dashboard/cart'} className="flex items-center justify-center px-2 w-14 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
          {
            (totalItems > 0) && 
           ( <span className='mr-2 text-sm text-blue-800 font-bold'>{ totalItems }</span> )
          }
